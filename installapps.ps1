...
$softwareList = @(
    @{ Number = 1; Name = "Zen Browser"; Description = "Firefox-based web browser"; Package = "zen" },
    @{ Number = 2; Name = "Greenshot"; Description = "Screenshot tool"; Package = "greenshot" },
    @{ Number = 3; Name = "Revo Uninstaller"; Description = "Advanced uninstaller"; Package = "revouninstaller" },
    @{ Number = 4; Name = ".NET 6 Runtime"; Description = "Microsoft .NET runtime"; Package = "dotnet-6.0-runtime" },
    @{ Number = 5; Name = "VC++ 2015-2022"; Description = "Visual C++ Redistributables"; Package = "vcredist-all" },
    @{ Number = 6; Name = "WebView2 Runtime"; Description = "Edge WebView2 runtime"; Package = "microsoft-edge-webview2" },
    ...
    @{ Number = 12; Name = "Spicetify"; Description = "Spotify customization tool"; Package = "spicetify-cli" },
    ...
    @{ Number = 20; Name = "Spotify"; Description = "Music streaming service"; Package = "spotify" },
